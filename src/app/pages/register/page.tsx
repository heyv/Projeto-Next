"use client";
import { Box, Button, Card, CardActions, CardContent, IconButton, InputAdornment, TextField, Typography, useMediaQuery } from "@mui/material";
import Grid from '@mui/material/Grid2';
import Link from "next/link";
import { Visibility, VisibilityOff } from '@mui/icons-material';
import { redirect, useRouter } from 'next/navigation';
import React, { useEffect, useState } from 'react'
import CustomizedSnackbars from "@/app/components/alert/Alert";
...
export default function Register() {
  ...
  const isDuplicateEmail = (users: UserLocal[], userData: { email: string }): boolean => {
    return users.some((user: UserLocal) =>
  ...
  const handleSubmit = () => {
    ...
    if (usersLocal.length > 0) {
      if (isDuplicateEmail(usersLocal, userData)) {
    ...
    >
      <Card sx={{
        ...
        <CardContent>
          ...
          <Typography sx={{ color: 'text.secondary', mb: 1.5, marginTop: 1, textAlign: 'center' }}>Preencha os campos abaixo para criar sua conta.</Typography>
